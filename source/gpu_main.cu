	...
	bool do_prescan)
{
	...
	driver d(data.capacity,
		...
		data.min_energy, data.max_energy, data.z_limit, data.SE_limit_zlim, seed);
...
int main(int argc, char** argv)
{
	...
	const real SE_cutoff_zlim = p.get_flag<real>("SE_cutoff_zlim");
	...
	data.SE_limit_zlim = SE_cutoff_zlim;
